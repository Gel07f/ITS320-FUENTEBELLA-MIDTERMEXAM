...
@Component({
  ...
  <div class="bg-black p-8 rounded-lg shadow-md w-full max-w-md">
    <h1 class="text-2xl font-bold text-pink-300 text-center mb-4">Sign Up</h1>
    ...
    <p class="mt-4 text-center text-pink-200">
      ...
      <a routerLink="/login" class="text-pink-400 hover:underline">Login</a>
    </p>
  </div>
</div>
  `
...
export class SignupComponent {
  ...
  signup() {
    this.http.post<{ token: string }>('http://localhost:3003/api/auth/signup', {
